...
class RF24CSMARadio: public RadioHandler<RadioPacket>, public Telemetry {
public:
	RF24CSMARadio(bool primary, uint8_t ce_pin, uint8_t csn_pin, uint8_t channel);
	virtual ~RF24CSMARadio();
